...
namespace Chromely.CefGlue.Libui.BrowserWindow
{
    ...
    using Chromely.CefGlue.Libui.Browser.Handlers;
    using Chromely.Core;
    ...
    public abstract class HostBase : IChromelyWindow, IChromelyServiceProvider, IDisposable
    {
        ...
        private int RunInternal(string[] args)
        {
            ...
            {
                MultiThreadedMessageLoop = HostRuntime.HostPlatform == CefRuntimePlatform.Windows,
            ...
            HostRuntime.EnsureNativeFileExists();
