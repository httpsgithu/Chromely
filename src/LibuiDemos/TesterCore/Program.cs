...
namespace TesterCore
{
    ...
    using Chromely.CefGlue.Libui.BrowserWindow;
    using Chromely.Core;
            ...
            try
            {
                ...
                */
                ...
                var config = ChromelyConfiguration
                              ...
                              //.WithCommandLineArg("disable-gpu")
                              //.WithCommandLineArg("disable-software-rasterizer")
                              //.WithCommandLineArg("disable-gpu-compositing")
                              //.WithCommandLineArg("disable-smooth-scrolling")
